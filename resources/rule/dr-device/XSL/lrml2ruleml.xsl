...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="lrml:LegalRuleML">
        <RuleML>
            ...
            <xsl:attribute name="rdf_export_classes">guilty_hunting_1 guilty_hunting_2 guilty_hunting_3 guilty_hunting_4 guilty_hunting_5 guilty_fishing_1 guilty_fishing_2 guilty_fishing_3 guilty_fishing_4 has_mitigating has_aggravating mitigation_allowed suspended_sentence_possible to_imprison_min to_imprison_max</xsl:attribute>
